...
class FearTrainingGUI:
    ...
    def setup_ui(self):
        ...
        ttk.Button(device_frame, text="Add Camera", command=self.add_camera).grid(row=0, column=0, padx=5, pady=5)
        ...
        ttk.Button(device_frame, text="Start Preview All", command=self.start_preview_all).grid(row=1, column=0, padx=5, pady=5)
        ttk.Button(device_frame, text="Stop Preview All", command=self.stop_preview_all).grid(row=2, column=0, padx=5, pady=5)
    ...
    def create_camera_view(self, camera_id):
        ...
        row = len(self.camera_views) // 2
        col = len(self.camera_views) % 2
